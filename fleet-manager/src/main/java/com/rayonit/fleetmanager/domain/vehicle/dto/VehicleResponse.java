...
public class VehicleResponse {
    ...
    public VehicleResponse(String vehicleID, String userID, CompanyInfo companyInfo, FleetInfo fleetInfo, String driverID, String vehicleName, Type type, Double fuel, int speed, Position position) {
